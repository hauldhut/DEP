...
#doCrossVal <- function(adjMat = en, nfold = 10, nsplit = 5) {
  ...
  ## all one positions
  onePos <- which(adjMat == 1, arr.ind = TRUE)#Tra ve index dang row, col
  onePosOrg <- onePos
  ...
  ##########################################################
  ##########################################################
  #Dam bao onePos chua cac row va col index ung voi cac row va col co rowSums va colSum >nLink
